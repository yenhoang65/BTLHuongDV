function setupCarousel(carouselElement) {
    ...
    const arrowIcons =
        carouselElement.parentElement.querySelectorAll(".milk-diapers .arrow");
    ...
    arrowIcons.forEach((icon) => {
        icon.addEventListener("click", () => {
            const firstImgWidth = firstImg.clientWidth + 700; // getting first img width & adding 15 margin value
...
// Example usage:
const carou = document.querySelectorAll(".milk");
